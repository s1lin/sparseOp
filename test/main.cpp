...
#include "TriangularParallelSolver.h"
...
//    b.print();
    ...
    TriangularParallelSolver<VectorType::sparse, double> triangularPSolve(A, b3);
    cout << "-------Begin Parallel solve-------" << endl;

    gettimeofday(&tim, NULL);
    t1 = tim.tv_sec + (tim.tv_usec / 1e+6);

    triangularPSolve.analysis();
